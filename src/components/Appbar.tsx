...
export function Appbar(){
    ...
    return (
        <div className="flex justify-between p-4 border-b border-gray-600 dark:from-gray-900 dark:to-gray-800">
            <div className="flex justify-center items-center text-xl font-bold">
                Thumbnail Downloader
            </div>

            <div className="pr-4 flex justify-center items-center gap-4">
            <div className="ml-2">
